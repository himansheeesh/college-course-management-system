...
public:
    ...
    void viewSchedule()         //UTC-005 & FA-001
    {
        ...
        ifstream f1("/Users/himan/OneDrive/Desktop/trainerallotment.csv");
        while (f1 >> batchID >> technology >> startDate >> endDate >> nod >> nop >> salary >> facultyName)
        {
    ...
    void facultyModules()
    {
        ...
        cout << "\tEnter 2 -> To Quit From This Session" << endl;
        cout << "--------------------------------------------------------" << endl;
